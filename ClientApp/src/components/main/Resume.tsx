                ...
                <div>
                    <div className='left'>
                        ...
                        performance by 75%&nbsp;</span>
                            ...
                            <ul>
                                <li>
                                    <span className='highlight inline'>Presenter of 2 Meetups</span> in Bangkok:
                                    <a
                                        target='_blank'
                                        href='https://www.youtube.com/watch?v=6NM-vMHVqeU&list=PLN6GB29N6NmHgVznqf-AUGUVsy8DLRo0v'
                                    >
                                        TypeScript training
                                    </a> and Full Open-Source&nbsp;
                                    <a
                                        target='_blank'
                        ...
                        <ul>
                            ...
                            <ul>
                                ...
                                <li>Added static code analysis with
                        ...
                        <ul>
                            <li>Designed and implemented&nbsp;
                                <a
                                    ...
                                    target='_blank'
                                >www.yesijoin.com
                                </a> from scratch using J2EE technology:
                                </li>
                            <ul>
                    ...
                    <div className='right'>
                        ...
                        <ol>
                            <li>Develop&nbsp;
                                <a href='https://sawan.io'>sawan.io</a> website as a medium to keep learning
                            ...
                            <li>Various base&nbsp;
                                <a
                                    ...
                                    target='_blank'
                                >docker images
                                </a> to facilitate build and hosting of web-application</li>
                        </ol>
